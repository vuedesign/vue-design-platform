      ...
      {count && (
        <ul className={styles.count}>
          <li>
            ...
            <span className={styles['count-text']}>{count.sites}</span>
          </li>
          <li>
            <span className={styles['count-icon']}>
              <PreviewOpen theme="outline" size="14" fill="#3d80fd" />
            </span>
            <span className={styles['count-text']}>{count.views}</span>
          </li>
          <li>
            <span className={styles['count-icon']}>
              <Like theme="outline" size="14" fill="#3d80fd" />
            </span>
            <span className={styles['count-text']}>{count.collections}</span>
          </li>
          <li>
            <span className={styles['count-icon']}>
              <ThumbsUp theme="outline" size="14" fill="#3d80fd" />
            </span>
            <span className={styles['count-text']}>{count.top}</span>
          </li>
          <li>
            <span className={styles['count-icon']}>
              <ThumbsDown theme="outline" size="14" fill="#3d80fd" />
            </span>
            <span className={styles['count-text']}>{count.down}</span>
          </li>
        </ul>
      )}
      {user && (
